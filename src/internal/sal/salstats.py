...
from internal.sal.tilenode import TileNode, TileType


def __custom_get_all(game: SnakesAndLadders, team_func, pass_tiles=False):
    stats = []
...
def get_all_average_total_rolls(game: SnakesAndLadders):
    return __custom_get_all(game, get_team_avg_total_roll)


def get_all_tiles_speed(game: SnakesAndLadders):
    return __custom_get_all(game, get_team_tiles_speed, True)


def get_all_tiles_before_end(game: SnakesAndLadders):
    return __custom_get_all(game, get_team_tiles_before_end, True)


def get_formatted_team_stats(game: SnakesAndLadders, team: Team):
...
def get_formatted_game_stats(game: SnakesAndLadders):
