...
from internal.sal import boardgenerator
...
class SnakesAndLadders:
    ...
    def set_start_index(self, tile_index):
        ...
        for team in self.teams:
            team.set_start_tile(self.tiles, self.tiles[tile_index], self.start_time)
    ...
    def choose_destination(self, team, destination):
        return team.choose_destination(destination, self.start_time, self.tiles)
    ...
    def add_team(self, team: Team):
        ...
        if self.start_index is not None:
            team.set_start_tile(self.tiles, self.tiles[self.start_index], self.start_time)
